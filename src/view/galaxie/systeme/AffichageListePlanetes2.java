...
public class AffichageListePlanetes2 extends VerticalGroup {
	
	public AffichageListePlanetes2(Systeme systeme, Skin skin) {
		super();
		...
		for (Planete planete : systeme.getTPlanete()) {
			...
			bouton.addListener(new ClickListener() {
				...
				public void clicked(InputEvent event, float x, float y) {
					...
					parent.clear();
					parent.addActor(new AffichagePlanete2(systeme, planete, skin));
				}
			});
