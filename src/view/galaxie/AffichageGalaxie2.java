...
//	private AffichageRessources ressources;
	...
	public void render() {
		...
		if (Project.systemeSelectionne != null && Project.changeSysteme) {
			...
			AffichageSysteme2 systeme = new AffichageSysteme2(Project.systemeSelectionne, Project.skin);
		...
		if (Project.planeteSelectionne != null && Project.changePlanete) {
			...
			AffichagePlanete2 planete = new AffichagePlanete2(Project.planeteSelectionne, Project.skin);
		...
		if (Project.planeteSelectionne != null && Project.planeteSelectionne.isReDraw()) {
			((AffichagePlanete2) afficheurDroite.findActor("afficheur_planete")).update(Project.planeteSelectionne);
			Project.planeteSelectionne.setReDraw(false);
			((AffichageSysteme2) afficheurDroite.findActor("afficheur_systeme")).update(Project.systemeSelectionne);
		}
	}
}
